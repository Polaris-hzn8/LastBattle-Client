...
public class MarketRuneListModel : Singleton<MarketRuneListModel> {
    ...
    public Dictionary<uint, OneRuneInfo> GetBuyedRuneDict() { return buyedRuneInfoDict; }
    ...
    public Dictionary<int, RuneGoodsInfo> GetRuneCfgListDict() { return RunecfgListDict; }
