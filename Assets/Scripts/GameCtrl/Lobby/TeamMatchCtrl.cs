...
public class TeamMatchCtrl : Singleton<TeamMatchCtrl> {
    public void Enter() { EventCenter.Broadcast(EGameEvent.eGameEvent_TeamMatchEnter); }
    ...
    // 邀请好友组队匹配
    public void InvitationFriend(string nickName) { CGLCtrl_GameLogic.Instance.AskInvitationFriend(nickName); }
    ...
    // 请求开始匹配
    public void AskStartMatch() { CGLCtrl_GameLogic.Instance.AskStartTeamMatch(); }

    // 请求停止匹配
    public void AskStopMatch() { CGLCtrl_GameLogic.Instance.AskStopTeamMatch(); }

    // 开始匹配
    public void StartMatchSearching() { EventCenter.Broadcast(EGameEvent.eGameEvent_TeamMatchSearchinEnter); }

    // 停止匹配
    public void StopMatchSearching() { EventCenter.Broadcast(EGameEvent.eGameEvent_TeamMatchSearchinExit); }

    // 取得队友列表
    public Dictionary<string, Teammate> GetTeammateList() { return mTeammateList; }
    ...
    // 隐藏组队邀请
    public void HideInvitation() { EventCenter.Broadcast(EGameEvent.eGameEvent_TeamMatchInvitationExit); }

    // 接受组队邀请
    public void AccpetInvitation(string name) { CGLCtrl_GameLogic.Instance.AskAcceptInvitation(name); }
    ...
    // 退出队伍
    public void QuitTeam() { CGLCtrl_GameLogic.Instance.AskQuitTeam(); }
    ...
    public EBattleMatchType GetMatchType() { return mMatchType; }
