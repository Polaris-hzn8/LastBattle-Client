...
public class UICenterTurnPage : MonoBehaviour {
    ...
    public void Recenter() {
        ...
        // if (UICamera.currentTouch != null && UICamera.currentTouch.current != null && UICamera.currentTouch.current
        // == trans.GetChild(index).gameObject)
        //{
    ...
    void CenterOn(Transform target, Vector3 panelCenter) {
        if (target != null && mScrollView != null && mScrollView.panel != null) {
            ...
            SpringPanel
                .Begin(mScrollView.panel.cachedGameObject, panelTrans.localPosition - localOffset, springStrength)
