...
public class FingerGestures : MonoBehaviour {
    public static FingerGestures Instance { private set; get; }
    ...
    public enum TouchDragState { Begin, StartDrag, Drag, End }
    ...
    protected void ProcessTouches() {
        ...
        for (int i = 0; i < Input.touchCount; ++i) {
            ...
            if (UICamera.hoveredObject != null && UICamera.hoveredObject.name != "GameUI")
                continue;
            if (selection == null) {
                continue;
            }
