...
public class ChatTaskCtrl : Singleton<ChatTaskCtrl> {
    ...
    public void ShowChatTask() { EventCenter.Broadcast(EGameEvent.eGameEvent_ShowChatTaskFriend); }
    public void SetNewChat() { EventCenter.Broadcast<bool>(EGameEvent.eGameEvent_ReceiveLobbyMsg, false); }
