...
public class CrticalStrike : MonoBehaviour {
    ...
    void Awake() { DigitNum = transform.Find("DigitNum").GetComponent<UILabel>(); }
    public Ientity CrticalOwner { set; get; }
    ...
    public void SetShowDighit(int count) {
        ...
        //}
        isAni = true;
        // TweenPosition.Begin(this.gameObject, 1.5f, new Vector3(transform.localPosition.y, transform.localPosition.z +
        // 5, transform.localPosition.x));
