...
public class MarketRuneListCtrl : Singleton<MarketRuneListCtrl> {
    public void Enter() { EventCenter.Broadcast(EGameEvent.eGameEvent_MarketRuneListEnter); }

    public void Exit() { EventCenter.Broadcast(EGameEvent.eGameEvent_MarketRuneListExit); }
    ...
    public void SetSelectGoods(int runeId) { mGoodsSelect = runeId; }
