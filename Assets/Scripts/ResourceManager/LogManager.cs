...
public class LogManager : Singleton<LogManager> {
    ...
    public void Show() {
        ...
        if (mDebugStringVisible) {
            ...
            scrollViewVector =
                GUI.BeginScrollView(new Rect(0, 0, (int)(Screen.width * 0.6), (int)(Screen.height * 0.6)),
                                    scrollViewVector,
                                    new Rect(0, 0, (int)(Screen.width * 0.5), log[selectTyleName].Length));
            ...
            scrollSelectVector =
                GUI.BeginScrollView(new Rect(0, 0, 90, 80), scrollSelectVector, new Rect(0, 0, 30, log.Count * 60));
            int index = 0;
    ...
    public void changeShowType(string typeName = "DEFAULT") { selectTyleName = typeName; }
}
