...
public class GameConfig : Singleton<GameConfig> {
    ...
    // 保存配置信息
    public void Save() { xml.SaveToFile(mGameConfigPath); }

    // 读取配置信息
    public string LoadProfileString(string section, string item) { return xml[section].Attributes[item]; }

    // 写入配置信息
    public void WriteProfileString(string section, string item, string value) { xml[section].Attributes[item] = value; }
