    ...
    private void ChangePageCount(int i) {
        ...
        switch (i) {
            case 1:
                ...
                // mFocusPic.transform.localPosition = new Vector3(514, mFocusPic.transform.localPosition.y,
                // mFocusPic.transform.localPosition.z); mFocusPic.clipOffset = new Vector2(-514,
                // mFocusPic.clipOffset.y);
                break;
            case 2:
                mPoint2.SetActive(true);
                // mFocusPic.transform.localPosition = new Vector3(0, mFocusPic.transform.localPosition.y,
                // mFocusPic.transform.localPosition.z); mFocusPic.clipOffset = new Vector2(0, mFocusPic.clipOffset.y);
                break;
            case 3:
                mPoint3.SetActive(true);
                // mFocusPic.transform.localPosition = new Vector3(-514, mFocusPic.transform.localPosition.y,
                // mFocusPic.transform.localPosition.z);
