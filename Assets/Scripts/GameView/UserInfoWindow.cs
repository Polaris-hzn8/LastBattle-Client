...
public class UserInfoWindow : BaseWindow {
    ...
    public void CreateHead() {
        ...
        ResourceUnit objUnit =
            ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadGameHeroHead, ResourceType.PREFAB);
    ...
    public override void OnEnable() {
        ...
        // IGuideTaskManager.Instance().AddTaskStartListerner(EGameEvent.eGameEent_UIGuideInputNickNameStart,
        // StartIGuideTask);
        // IGuideTaskManager.Instance().AddTaskStartListerner(EGameEvent.eGameEvent_UIGuideSelectSexStart,
        // StartIGuideTask);
        // IGuideTaskManager.Instance().AddTaskStartListerner(EGameEvent.eGameEvent_UIGuideSelectHeadStart,
        // StartIGuideTask);
        // IGuideTaskManager.Instance().AddTaskStartListerner(EGameEvent.eGameEvent_UIGuideCommitRegisterStart,
        // StartIGuideTask); IGuideTaskManager.Instance().SendTaskTrigger(EGameEvent.eGameEvent_UIGuideTriggerRegister);
    ...
    public override void OnDisable() {
        ...
        // IGuideTaskManager.Instance().RemoveTaskStartListerner(EGameEvent.eGameEent_UIGuideInputNickNameStart,
        // StartIGuideTask);
        // IGuideTaskManager.Instance().RemoveTaskStartListerner(EGameEvent.eGameEvent_UIGuideSelectSexStart,
        // StartIGuideTask);
        // IGuideTaskManager.Instance().RemoveTaskStartListerner(EGameEvent.eGameEvent_UIGuideSelectHeadStart,
        // StartIGuideTask);
        // IGuideTaskManager.Instance().RemoveTaskStartListerner(EGameEvent.eGameEvent_UIGuideCommitRegisterStart,
        // StartIGuideTask);
    }
...
#region 箭头效果
    ...
    void PlayerArrowAnimation() {
        UITweener tweenpos = TweenPosition.Begin(
            arrowObj,
            during,
            new Vector3(arrowObj.transform.localPosition.x, arrowObj.transform.localPosition.y + yTween, 0f));
    ...
    void SubmitRegister() {
        ...
        CGLCtrl_GameLogic.Instance.GameCompleteBaseInfo(
            SelectServerData.Instance.serverUin, bytes, Convert.ToInt32(spriteHead.spriteName), isBoy);
    }
}
}
