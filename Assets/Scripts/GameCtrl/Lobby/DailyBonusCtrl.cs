...
public class DailyBonusCtrl : Singleton<DailyBonusCtrl> {
    ...
    public void Enter() { EventCenter.Broadcast(EGameEvent.eGameEvent_DailyBonusEnter); }

    public void Exit() { EventCenter.Broadcast(EGameEvent.eGameEvent_DailyBonusExit); }
    ...
    public void AskGetAwards() { CGLCtrl_GameLogic.Instance.AskGetLoginReWard(); }
}
