...
public class CMemBuffer {
    ...
    public byte[] GetMemBuffer() { return this.m_msStream.GetBuffer(); }

    public Int32 GetBufferSize() { return this.m_n32BufferSize; }

    public Int32 GetWritePos() { return this.m_n32WritePos; }

    public Int32 GetReadPos() { return this.m_n32ReadPos; }
    ...
    public void SetReadPos(Int32 n32NewPos) { this.m_n32ReadPos = n32NewPos; }

    public void SetWritePos(Int32 n32NewPos) { this.m_n32WritePos = n32NewPos; }
