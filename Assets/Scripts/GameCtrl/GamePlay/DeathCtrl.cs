...
public class DeathCtrl : Singleton<DeathCtrl> {
    public void Enter() { EventCenter.Broadcast(EGameEvent.eGameEvent_NotifyDeathEnter); }

    public void Exit() { EventCenter.Broadcast(EGameEvent.eGameEvent_NotifyDeathExit); }
    ...
    internal void SendBtn() { CGLCtrl_GameLogic.Instance.Resurrection(); }
}
}