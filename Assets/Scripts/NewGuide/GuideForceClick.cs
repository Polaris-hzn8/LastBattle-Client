...
public class GuideForceClick : GuideTaskBase {
    ...
    public GuideForceClick(int task, GuideTaskType type, GameObject mParent) : base(task, type, mParent) {}
    ...
    private void LoadGuideFrame() {
        ResourceUnit Unit =
            ResourcesManager.Instance.loadImmediate("Guide/" + mTaskInfo.PrefabName, ResourceType.PREFAB);
    ...
    public override void ClearTask() {
        ...
        //{
        //     EventCenter.RemoveListener<ButtonDragType>(EGameEvent.eGameEvent_PlayGuideDragEvent,
        //     OnGameObjectDragEvent);
        // }
