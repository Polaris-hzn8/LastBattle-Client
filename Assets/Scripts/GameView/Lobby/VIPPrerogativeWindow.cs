...
public class VIPPrerogativeWindow : BaseWindow {
    ...
    private void CloseButton(GameObject go) { VIPPrerogativeCtrl.Instance.Exit(); }
    ...
    void ShowVipPre() {
        ...
        foreach (var item in ConfigReader.ViplevelXmlInfoDict.Values) {
            ...
            ResourceUnit objHomeBaseUnit =
                ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadVIPInfoUI, ResourceType.PREFAB);
