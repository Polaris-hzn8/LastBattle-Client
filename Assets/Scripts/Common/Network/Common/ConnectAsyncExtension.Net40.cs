...
public static partial class ConnectAsyncExtension {
    ...
    static ConnectAsyncExtension() {
        ...
        var pro_OSSupportsIPv4 =
            typeof(Socket).GetProperty("OSSupportsIPv4", BindingFlags.Public | BindingFlags.Static);
    ...
    public static Socket ConnectSync(this EndPoint remoteEndPoint) { return ConnectSyncInternal(remoteEndPoint); }
