...
public class ResourceUpdateManager : UnitySingleton<ResourceUpdateManager> {
    ...
    public int AllNeedDownLoadBytes {
        get { return mAllNeedDownLoadBytes; }
    }
    ...
    public bool ForceTermination {
        get { return mForceTermination; }
    }

    public bool NetworkConnections {
        get { return mNetworkConnections; }
    }
    ...
    public void OnGUI() {
        ...
        // GUI.Label(new Rect(0, Screen.height / 2 - 20, Screen.width, 20), "进度1: " + mAllNeedDownLoadSize + " : " +
        // mCurrentDownLoadSize);

        // GUI.Label(new Rect(0, Screen.height / 2, Screen.width, 20), "进度2: " + mAllNeedDownLoadBytes + " : " +
        // mCurrentDownLoadBytes);
...
*/
    ...
    private bool needUpdate(VersionResourceFile local,
                            VersionResourceFile server,
                            List<string> update,
                            List<int> updateSize) {
        // 后期采用先判定版本号
    ...
    void OnEnable() {
        ...
        //  UIPlayMovie.PlayMovie("logo.mp4", Color.black,3/* FullScreenMovieControlMode.Hidden*/,
        //  3/*FullScreenMovieScalingMode.Fill*/);
        //  }
    }
    ...
    // 确认更新
    private void ConfirmUpdate(int ie, bool isPress) { Debug.LogError("confirm update"); }
