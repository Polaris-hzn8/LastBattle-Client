...
public class EntityManager {
    ...
    public virtual Ientity HandleCreateEntity(UInt64 sGUID, EntityCampType campType) {  // entity id
    ...
    public static int HandleDelectEntity(UInt64 sGUID) {
        ...
        if (entity.entityType == EntityType.Building) {
            ...
            // 删除GameObject
            GameObjectPool.Instance.ReleaseGO(
                AllEntitys[sGUID].resPath, AllEntitys[sGUID].realObject, PoolObjectType.POT_Entity);
        }
        ...
        if (entity != null) {
            ...
            if (entity is Iplayer) {
                ...
                if (entity.entityType == EntityType.Monster &&
                    (int)entity.EntityCamp >= (int)EntityCampType.CampTypeA) {
    ...
    protected virtual string GetModeName(int id) { return null; }
    ...
    public static void AddEntityComponent(Ientity entity) {
        ...
        if (entity.realObject.GetComponent<Entity>() == null) {
            ...
            if (entity.entityType == EntityType.Monster || entity.entityType == EntityType.Soldier ||
                entity.entityType == EntityType.AltarSoldier) {
                OptimizeDynamicModel optimizeDynamicModel =
                    entity.realObject.AddComponent<OptimizeDynamicModel>() as OptimizeDynamicModel;
    ...
    public static void ClearHomeBase() { homeBaseList.Clear(); }

    public static bool IsSelfHomeBase(Ientity entity) {
        if (entity == null)
            return false;
        if (PlayerManager.Instance.LocalPlayer != null &&
            PlayerManager.Instance.LocalPlayer.EntityCamp != entity.EntityCamp)
            return false;
        for (int i = 0; i < HOME_BASE_ID.Length; i++) {
            if (HOME_BASE_ID[i] == entity.NpcGUIDType) {
                return true;
    ...
    public static List<Ientity> GetHomeBaseList() { return homeBaseList; }
}
}