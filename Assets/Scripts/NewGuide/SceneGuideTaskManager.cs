...
public class SceneGuideTaskManager {
    ...
    public SceneGuideTaskBase sceneGuideTask { private set; get; }
    ...
    public void FinishAll() { sceneGuideTask = null; }
    ...
    private SceneGuideTaskManager() { sceneGuideTask = null; }
    ...
    public void SetHasFinishedAllGuide(bool finish) { hasFinishAllGuide = finish; }

    public bool HasFinishAllGuide() { return hasFinishAllGuide; }
