...
public class GameUserModel : Singleton<GameUserModel> {
    ...
    public UInt64 GameRoomID { get; set; }

    public UInt32 GameMapID { get; set; }

    public UInt64 GameBattleID { get; set; }

    public UInt64 GameScore { get; private set; }

    // ss和本地时差
    public Int64 STCTimeDiff { get; set; }

    /// <summary>
    /// 帐号当前钻石
    /// </summary>
    public UInt64 mGameUserDmd { private set; get; }

    public string mGameUserName { get; private set; }

    public string GameUserNick { get; private set; }
    public void SetGameUserNick(string nickName) { GameUserNick = nickName; }
    public void SetGameUserHead(int headid) { GameUserHead = headid; }

    public byte GameUserSex { get; private set; }

    public Int32 GameUserHead { get; private set; }
    ...
    /// 帐号当前的金币
    /// </summary>
    public UInt64 mGameUserGold { private set; get; }

    public Int16 UserLevel { private set; get; }
    ...
    public void OnChangGold(UInt64 curgold) { mGameUserGold = curgold; }
    public void ChangeReconnect(bool isvib) { IsReconnect = isvib; }
    /// <summary>
    /// 帐号当前钻石改变
    /// </summary>
    ...
    public int GameUserExp { private set; get; }
    public int GameUserVipLevel { private set; get; }
    public int GameUserVipIntegral { private set; get; }

    public bool IsLocalPlayer(UInt64 sGUID) { return sGUID == GameUserGUID; }
    ...
    int GetSecond(long time) { return (int)time % 60; }

    int GetMinute(long time) { return (int)time / 60 % 60; }

    int GetHour(long time) { return (int)time / 3600 % 24; }

    int GetDay(long time) { return (int)time / 3600 / 24; }

    /// <summary>
    /// 当前获得的商品的类型
    /// </summary>
    public MarketGoodsType NewCommodityType { private set; get; }

    /// <summary>
    /// 当前获得的商品的Id
    /// </summary>
    public int NewCommodityId { private set; get; }
    ...
    public void GameUserGetNewCommodity(int Cmdityid) {
        ...
        CommodityInfos info =
            new CommodityInfos() { goodsId = Cmdityid, GoodsType = NewCommodityType, Expired_time = expiredTime };
    ...
    public void SetGameUserGUID(ulong sGUID) { GameUserGUID = sGUID; }

    public void SetGameUserExp(int mExpValue) { GameUserExp = mExpValue; }
}
