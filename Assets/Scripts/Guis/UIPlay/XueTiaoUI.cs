...
#region 血条类型
    public XueTiaoType xueTiaoType { private set; get; }
#endregion

#region 血条的归属者
    public Ientity xueTiaoOwner { private set; get; }
#endregion
...
#region 初始化血条
    public virtual void ResetXueTiaoValue() { hpSprite.fillAmount = 0f; }
#endregion

#region 创建血条之后，接收到服务器发送的血条信息，初始化血条
    public virtual void SetXueTiaoInfo() { UpdateHP(); }
#endregion

    public void UpdateHP() { hpSprite.fillAmount = xueTiaoOwner.Hp / xueTiaoOwner.HpMax; }
