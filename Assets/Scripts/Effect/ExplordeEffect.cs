    ...
    public override void OnLoadComplete() {
        ...
        if (obj != null && enOwner != null) {
            ...
            if (point != null) {
                ...
                // Debug.LogError("fly effect init pos:" + root.transform.position.x + ":" + root.transform.position.y +
                // ":" + root.transform.position.z);
                if (mType == IEffect.ESkillEffectType.eET_FlyEffect && enTarget != null) {
                    Quaternion rt =
                        Quaternion.LookRotation(enTarget.RealEntity.transform.position - GetTransform().position);
