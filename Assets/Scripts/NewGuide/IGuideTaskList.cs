...
public class IGuideTaskList {
    ...
    protected void SetTaskState(TaskState state) { curState = state; }
    ...
    public IGuideTaskList(int id) { SetTaskData(id); }

    protected virtual void SetTaskData(int id) {
        taskId = id;
        taskData = ConfigReader.GetIGuideManagerInfo(taskId);
    }
    public IGuideManagerData GetIGuideTaskData() { return taskData; }
