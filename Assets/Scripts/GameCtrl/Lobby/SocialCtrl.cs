...
public class SocialCtrl : Singleton<SocialCtrl> {
    public void Enter() { EventCenter.Broadcast(EGameEvent.eGameEvent_SocialEnter); }

    public void Exit() { EventCenter.Broadcast(EGameEvent.eGameEvent_SocialExit); }
    ...
    internal void AskBlackList() { CGLCtrl_GameLogic.Instance.EmsgTocs__AskBlackListOnlineInfo(); }
}
