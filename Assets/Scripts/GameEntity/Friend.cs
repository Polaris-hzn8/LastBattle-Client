...
public class Friend {
    public UInt64 SGUID { private set; get; }
    public bool isOnline { private set; get; }
    public string NiceName { private set; get; }

    public int HeadId { private set; get; }
    public uint isVip { private set; get; }
    public FRIENDTYPE FriendType { private set; get; }
