...
public class SceneSoundManager {
    ...
    public void addSound(AudioSource audioSource, GameObject obj) { sceneSound[audioSource] = obj; }
        ...
        foreach (KeyValuePair<AudioSource, GameObject> p in sceneSound) {
            if (p.Value != null && p.Key != null) {
                ...
                if (PlayerManager.Instance.LocalPlayer != null &&
                    PlayerManager.Instance.LocalPlayer.RealEntity != null) {
                    playerPos = PlayerManager.Instance.LocalPlayer.RealEntity.transform.position;
                } else if (UIViewerPersonInfo.Instance != null &&
                           UIViewerPersonInfo.Instance.SetCurrClickPlayer != null) {
