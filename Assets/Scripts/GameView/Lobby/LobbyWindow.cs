...
public class LobbyWindow : BaseWindow {
    ...
    private void GameSetting(GameObject go) { GameSettingCtrl.Instance.Enter(); }
    ...
    private void ChangeLevel() { mLevel.text = GameUserModel.Instance.UserLevel.ToString(); }
    private void ChangeNickName() {
        MsgInfoManager.Instance.ShowMsg(10039);
        mNickName.text = GameUserModel.Instance.GameUserNick;
    }

    private void ChangeHeadID() { mHeadIcon.spriteName = GameUserModel.Instance.GameUserHead.ToString(); }
    ...
    public override void OnEnable() {
        ...
        //             {
        //                 ResourceUnit objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadInputSend,
        //                 ResourceType.PREFAB); InputNotice = GameObject.Instantiate(objUnit.Asset) as GameObject;
    ...
    public void ChangeUserLevel() { mLevel.text = GameUserModel.Instance.UserLevel.ToString(); }
    ...
    public void OnHomePageChange() {
        ...
        if (leveinfo != null) {
            ...
            mExp.transform.parent.GetComponent<UISprite>().fillAmount =
                GameUserModel.Instance.GameUserExp / leveinfo.LevelUpExp;
    ...
    // 新邮件按钮状态闪烁
    void NoticeNewMail() { mMailBtnBg.SetActive(true); }
    ...
    /*
            ...
            {
                ResourceUnit objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadSystemNotice,
       ResourceType.PREFAB); if (NoticeObj == null)
                {
                ...
                EventCenter.Broadcast<string>(EGameEvent.eGameEent_SystemNotice,
       SystemNoticeData.Instance.SystemNotice);
            }
            ...
            void InvitatAddFriend(string nickName)
            {
                ...
                ResourceUnit objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadInvitationTips,
       ResourceType.PREFAB); GameObject obj = GameObject.Instantiate(objUnit.Asset) as GameObject; obj.transform.parent
       = mRoot; obj.transform.localPosition = Vector3.zero; obj.transform.localScale = Vector3.one; UIinviteTips tip =
       obj.GetComponent<UIinviteTips>(); tip.AddInvitaion(nickName);
            }
