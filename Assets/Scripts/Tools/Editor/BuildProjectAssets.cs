...
public class BuildProjectAssets {
    ...
    static void ExportScene(string path, BuildTarget bTarget) {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            if (lightmap != null) {
                if (BuildPipeline.BuildAssetBundle(lightmap,
                                                   null,
                                                   Application.dataPath + "/StreamingAssets/" + platformPath +
                                                       "/Scene/Texture/" + SceneName + "_" + lightmap.name +
                                                       ".assetbundle",
        ...
        if (File.Exists(probePath) == true) {
            ...
            if (lightprobe != null) {
                if (BuildPipeline.BuildAssetBundle(lightprobe,
                                                   null,
                                                   Application.dataPath + "/StreamingAssets/" + platformPath +
                                                       "/Scene/Texture/" + SceneName + "_" + "LightProbe.assetbundle",
                                                   BuildAssetBundleOptions.DeterministicAssetBundle,
                                                   sceneBuildTarget)) {
        ...
        foreach (UnityEngine.Object o in refObjs) {
            ...
            if (render != null && render.sharedMaterial != null) {
                lightmapIndexList.Add(render.gameObject.GetInstanceID() + "," + render.lightmapIndex + "," +
                                      string.Format("{0},{1},{2},{3}",
                                                    render.lightmapScaleOffset.x,
                                                    render.lightmapScaleOffset.y,
                                                    render.lightmapScaleOffset.z,
                                                    render.lightmapScaleOffset.w));
                // BlGame.Resource.LightmapHelper[] olds =
                // render.gameObject.GetComponents<BlGame.Resource.LightmapHelper>(); foreach
                // (BlGame.Resource.LightmapHelper helper in olds)
                //{
                //     GameObject.DestroyImmediate(helper,true);
                // }
                // BlGame.Resource.LightmapHelper lightMapHelper =
                // render.gameObject.GetComponent<BlGame.Resource.LightmapHelper>(); if (lightMapHelper == null)
                //{
                ...
                UnityEngine.Object[] renderRefObjs =
                    EditorUtility.CollectDependencies(new UnityEngine.Object[] { render.sharedMaterial });
                foreach (UnityEngine.Object ro in renderRefObjs) {
                    ...
                    if (t != null && exported == false) {
                        ...
                        BuildPipeline.BuildAssetBundle(t,
                                                       null,
                                                       Application.dataPath + "/StreamingAssets/" + platformPath +
                                                           "/Scene/Texture/" + t.name + ".assetbundle",
                                                       BuildAssetBundleOptions.DeterministicAssetBundle,
                                                       sceneBuildTarget);
            ...
            if (particle != null && particle.GetComponent<Renderer>() != null &&
                particle.GetComponent<Renderer>().sharedMaterials != null) {
                foreach (Material m in particle.GetComponent<Renderer>().sharedMaterials) {
                    UnityEngine.Object[] renderRefObjs =
                        EditorUtility.CollectDependencies(new UnityEngine.Object[] { m });
                    /////////////////////////////////////////////////////////////////////////
                    {
                        Shader s = m.shader;
                        bool exported = false;
                        ...
                        if (s != null && exported == false) {
                            BuildPipeline.BuildAssetBundle(s,
                                                           null,
                                                           Application.dataPath + "/StreamingAssets/" + platformPath +
                                                               "/Shader/" + BuildMethod.getShaderName(s.name) +
                                                               ".assetbundle",
                                                           BuildAssetBundleOptions.DeterministicAssetBundle,
                                                           sceneBuildTarget);
            ...
            //            BuildPipeline.BuildAssetBundle(t, null, Application.dataPath + "/StreamingAssets/" +
            //            platformPath + "/Scene/Texture/" + t.name + ".assetbundle",
            //            BuildAssetBundleOptions.DeterministicAssetBundle, sceneBuildTarget);
            //            depBundleNames.Add("Scene/Texture/" + t.name + ".assetbundle");
            //            texExportList.Add(t);
            //        }
            //    }
            ...
            if (mesh != null && mesh.sharedMesh != null) {
                ...
                if (exported == false) {
                    BuildPipeline.BuildAssetBundle(mesh.sharedMesh,
                                                   null,
                                                   Application.dataPath + "/StreamingAssets/" + platformPath +
                                                       "/Scene/Mesh/" + mesh.sharedMesh.name + ".assetbundle",
                                                   BuildAssetBundleOptions.DeterministicAssetBundle,
                                                   sceneBuildTarget);
            ...
            if (sound != null && sound.clip != null) {
                ...
                if (exported == false) {
                    BuildPipeline.BuildAssetBundle(sound.clip,
                                                   null,
                                                   Application.dataPath + "/StreamingAssets/" + platformPath +
                                                       "/Scene/Sound/" + sound.clip.name + ".assetbundle",
                                                   BuildAssetBundleOptions.DeterministicAssetBundle,
                                                   sceneBuildTarget);
        ...
        ////
        // lightmap index
        BlGame.Resource.StringScriptableObject lightmapindexholder =
            ScriptableObject.CreateInstance<BlGame.Resource.StringScriptableObject>();
        ...
        UnityEngine.Object lightmapIndex = AssetDatabase.LoadAssetAtPath(
            "Assets/temp/LightMapIndex.asset", typeof(BlGame.Resource.StringScriptableObject));
        //

        BlGame.Resource.StringScriptableObject holder =
            ScriptableObject.CreateInstance<BlGame.Resource.StringScriptableObject>();
        holder.content = depBundleNames.ToArray();
        AssetDatabase.CreateAsset(holder, "Assets/temp/DependentBundleNames.asset");
        UnityEngine.Object depBundleDescription = AssetDatabase.LoadAssetAtPath(
            "Assets/temp/DependentBundleNames.asset", typeof(BlGame.Resource.StringScriptableObject));
        UnityEngine.Object mainAsset = AssetDatabase.LoadMainAssetAtPath(prefabPath);

        // BuildPipeline.BuildAssetBundle(mainAsset, null, "Assets/Export/Prefab/" + curSceneName + "_Scene" +
        // ".assetbundle",   BuildAssetBundleOptions.CollectDependencies | BuildAssetBundleOptions.CompleteAssets);
        BuildPipeline.BuildAssetBundle(mainAsset,
                                       new UnityEngine.Object[] { depBundleDescription /*, lightmapIndex */ },
                                       Application.dataPath + "/StreamingAssets/" + platformPath + "/Scene/Prefab/" +
                                           SceneName + "_Scene" + ".assetbundle",
                                       options,
                                       sceneBuildTarget);
    ...
    static void ExportAllCharacterAssetBundles(BuildTarget bTarget) {
        ...
        BuildTarget sceneBuildTarget = bTarget;
        string[] characters =
            Directory.GetFiles(Application.dataPath + "/Resources/Monsters", "*", SearchOption.AllDirectories);
        BuildAssetBundleOptions options =
            BuildAssetBundleOptions.CollectDependencies | BuildAssetBundleOptions.DeterministicAssetBundle;
        List<string> depBundleNames = new List<string>();
        ...
        foreach (string s in characters) {
            ...
            foreach (UnityEngine.Object o in refObjs) {
                ...
                if (mat != null) {
                    UnityEngine.Object[] renderRefObjs =
                        EditorUtility.CollectDependencies(new UnityEngine.Object[] { mat });
                    {
                        ...
                        if (s1 != null && exported == false) {
                            BuildPipeline.BuildAssetBundle(s1,
                                                           null,
                                                           Application.dataPath + "/StreamingAssets/" + platformPath +
                                                               "/Shader/" + BuildMethod.getShaderName(s1.name) +
                                                               ".assetbundle",
                                                           BuildAssetBundleOptions.DeterministicAssetBundle,
                                                           sceneBuildTarget);
                    ...
                    foreach (UnityEngine.Object ro in renderRefObjs) {
                        ...
                        if (t != null && exported == false) {
                            ...
                            BuildPipeline.BuildAssetBundle(t,
                                                           null,
                                                           Application.dataPath + "/StreamingAssets/" + platformPath +
                                                               "/Character/Texture/" + t.name + ".assetbundle",
                                                           BuildAssetBundleOptions.DeterministicAssetBundle,
                                                           sceneBuildTarget);
                            ...
                            if (m != null) {
                                ...
                                if (pShader != null && exported == false) {
                                    BuildPipeline.BuildAssetBundle(
                                        pShader,
                                        null,
                                        Application.dataPath + "/StreamingAssets/" + platformPath + "/Shader/" +
                                            BuildMethod.getShaderName(pShader.name) + ".assetbundle",
                                        BuildAssetBundleOptions.DeterministicAssetBundle,
                                        sceneBuildTarget);
                                    depBundleNames.Add("Shader/" + BuildMethod.getShaderName(pShader.name) +
                                                       ".assetbundle");
                            ...
                            if (t != null && exported == false) {
                                ...
                                BuildPipeline.BuildAssetBundle(t,
                                                               ...
                                                               Application.dataPath + "/StreamingAssets/" +
                                                                   platformPath + "/Character/Texture/" + t.name +
                                                                   ".assetbundle",
                                                               BuildAssetBundleOptions.DeterministicAssetBundle,
                                                               sceneBuildTarget);
                                depBundleNames.Add("Character/Texture/" + t.name + ".assetbundle");
                ...
                //     if (exported == false)
                //     {
                //         BuildPipeline.BuildAssetBundle(mesh.sharedMesh, null, Application.dataPath +
                //         "/StreamingAssets/" + platformPath + "/Character/Mesh/" + mesh.sharedMesh.name +
                //         ".assetbundle", BuildAssetBundleOptions.DeterministicAssetBundle, sceneBuildTarget);
            ...
            BlGame.Resource.StringScriptableObject stringSO =
                ScriptableObject.CreateInstance<BlGame.Resource.StringScriptableObject>();
            stringSO.content = depBundleNames.ToArray();
            AssetDatabase.CreateAsset(stringSO, "Assets/Export/Temp/DependentBundleNames.asset");
            UnityEngine.Object depBundleDescription = AssetDatabase.LoadAssetAtPath(
                "Assets/Export/Temp/DependentBundleNames.asset", typeof(BlGame.Resource.StringScriptableObject));

            string folder = Application.dataPath + "/StreamingAssets/" + platformPath + "/Character/Prefab/";
            if (Directory.Exists(folder) == false) {
                Directory.CreateDirectory(folder);
            }
            BuildPipeline.BuildAssetBundle(eff,
                                           new UnityEngine.Object[] { depBundleDescription },
                                           folder + Path.GetFileNameWithoutExtension(s) + ".assetbundle",
                                           options,
                                           sceneBuildTarget);
            BuildPipeline.PopAssetDependencies();
        }
    ...
    static void ExportAllEffectsAssetBundles(BuildTarget bTarget) {
        ...
        string[] effects =
            Directory.GetFiles(Application.dataPath + "/Resources/effect", "*", SearchOption.AllDirectories);
        ...
        foreach (string s in effects) {
            ...
            if (s.EndsWith(".prefab")) {
                ...
                foreach (UnityEngine.Object o in refObjs) {
                    ...
                    //     {
                    //         BuildPipeline.BuildAssetBundle(mesh.sharedMesh, null, Application.dataPath +
                    //         "/StreamingAssets/" + platformPath + "/Effect/Mesh/" + mesh.sharedMesh.name +
                    //         ".assetbundle", options, sceneBuildTarget);
                    //         //Debug.Log("Mesh:" + AssetDatabase.GetAssetPath(mesh.sharedMesh));
                    //         depBundleNames.Add("Effect/Mesh/" + mesh.sharedMesh.name + ".assetbundle");
                    //         meshExportList.Add(mesh.sharedMesh);
                    //     }
                            ...
                            EditorUtility.CollectDependencies(new UnityEngine.Object[] { mat });
                        {
                            ...
                            if (s1 != null && exported == false) {
                                BuildPipeline.BuildAssetBundle(s1,
                                                               ...
                                                               Application.dataPath + "/StreamingAssets/" +
                                                                   platformPath + "/Shader/" +
                                                                   BuildMethod.getShaderName(s1.name) + ".assetbundle",
                                                               options,
                                                               sceneBuildTarget);
                                depBundleNames.Add("Shader/" + BuildMethod.getShaderName(s1.name) + ".assetbundle");
                                shaderExportList.Add(s1);
                        ...
                        foreach (UnityEngine.Object ro in renderRefObjs) {
                            ...
                            if (t != null && exported == false) {
                                ...
                                BuildPipeline.BuildAssetBundle(t,
                                                               null,
                                                               Application.dataPath + "/StreamingAssets/" +
                                                                   platformPath + "/Effect/Texture/" + t.name +
                                                                   ".assetbundle",
                                                               options,
                                                               sceneBuildTarget);
                ...
                string folder =
                    Application.dataPath + "/StreamingAssets/" + platformPath + "/Effect/Prefab/" + effectResFolder;
                if (Directory.Exists(folder) == false) {
                ...
                BuildPipeline.BuildAssetBundle(
                    eff,
                    new UnityEngine.Object[] { depBundleDescription },
                    Path.GetDirectoryName(folder) + "/" + Path.GetFileNameWithoutExtension(s) + ".assetbundle",
                    options,
                    sceneBuildTarget);
                BuildPipeline.PopAssetDependencies();
                BuildPipeline.PopAssetDependencies();
