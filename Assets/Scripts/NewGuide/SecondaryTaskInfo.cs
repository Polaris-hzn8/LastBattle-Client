...
public class SecondaryTaskInfo {
    ...
    public SecondaryTaskInfo() { Clean(); }
    ...
    public int GetTaskId() { return sTaskId; }
    ...
    public void OnEnter() { EventCenter.AddListener<CEvent>((EGameEvent)data.helpTriggerEvent, OnEventStart); }
