...
public class GuideShowObjTask : GuideTaskBase {
    ...
    public GuideShowObjTask(int task, GuideTaskType type, GameObject mParent) : base(task, type, mParent) {
        // 读取数据
    ...
    public override void EnterTask() { objShow.SetActive(showTask.StartShow == 1 ? true : false); }
