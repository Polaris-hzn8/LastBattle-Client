...
public class CMemQueue {
    ...
    public UInt32 GetSize() { return m_un32Size; }

    public UInt64 GetCachedDataSize() { return m_un64DataPushed - m_un64DataPoped; }

    public UInt64 GetPushedDataSize() { return m_un64DataPushed; }

    public UInt64 GetPopedDataSize() { return m_un64DataPoped; }
