...
public class DailyBonusData {
    ...
    public MaterDailyType DailType { private set; get; }
    public int NumOrID { private set; get; }
    public int EverydaySignIn { private set; get; }
    public bool IsHaveReward { private set; get; }
    // 每天签到消息
    ...
    public void SetHaveReward(bool isVab) { IsHaveReward = isVab; }
}
