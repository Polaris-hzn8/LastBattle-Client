...
public class LoadScene : MonoBehaviour {
    public static LoadScene Instance { private set; get; }

    public UIProgressBar m_ProGressbar;

    public bool isCloseBySelf = true;

    public GameStateType GState { set; get; }
    ...
    public void CloseLoading() { DestroyImmediate(this.gameObject); }
    void OnEnable() {
        if (m_ProGressbar != null) {
    ...
    //     BlGame.Resource.ResourceManager.Instance.loadProcess.AddLogicFile("Scene/Prefab/" + name +
    //     "_Scene.assetbundle", BlGame.Resource.LogicResouce.ELogicResType.ERes_Scene);
    //     BlGame.Resource.ResourceManager.Instance.loadProcess.SceneRes = "Scene/Prefab/" + name +
    //     "_Scene.assetbundle";
    // }
    ...
    void SetEffectPos() {
        ...
        Vector3 pos = new Vector3(value * m_ProGressbar.foregroundWidget.width + startX,
                                  m_ProGressbar.foregroundWidget.transform.localPosition.y,
                                  m_ProGressbar.foregroundWidget.transform.localPosition.z);
        // Vector3 pos = new Vector3(value * m_ProGressbar.foregroundWidget.width + xOffset,
        // m_ProGressbar.foregroundWidget.transform.localPosition.y,
        // m_ProGressbar.foregroundWidget.transform.localPosition.z);
