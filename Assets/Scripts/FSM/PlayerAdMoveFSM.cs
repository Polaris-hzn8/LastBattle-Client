...
public class PlayerAdMoveFSM : EntityFSM {
    ...
    public FsmState State {
        get { return FsmState.FSM_STATE_ADMOVE; }
    }
    ...
    public void Enter(Ientity entity, float last) { entity.OnEnterEntityAdMove(); }

    public void Execute(Ientity entity) { entity.OnExecuteEntityAdMove(); }
