...
public class SlotInfo {
    public GameObject runeInfo { set; get; }
...
public class RuneCombineWindow : BaseWindow {
    ...
    // 窗口控件释放
    protected override void RealseWidget() { m_RuneComposeState = RuneComposeState.stepNone; }

    private bool IfCanShow(int level) { return m_CurLevel == 0 || m_CurLevel == level; }
        ...
        switch (m_RuneComposeState) {
            ...
            case RuneComposeState.step1: {
                ...
                if (curTime - m_ComposeTime >= ComposeStateWaitTime[(int)m_RuneComposeState]) {
                    ...
                    var go = LoadUiResource.AddChildObject(m_CombineSuccessFlash1GO.transform,
                                                           GameConstDefine.RuneDisappearFlash);
                    go.name = effectName2;
                }
            }
