...
public class SelectServerData : Singleton<SelectServerData> {
    ...
    public string GateServerAdress { set; get; }

    public int GateServerPort { set; get; }

    public string GateServerToken { set; get; }

    Dictionary<int, ServerInfo> serverInfoDic = new Dictionary<int, ServerInfo>();

    public int serverPlafrom { private set; get; }

    public string serverUin { private set; get; }

    public string serverSionId { private set; get; }

    public string gateServerUin { private set; get; }

    public void Clean() { serverInfoDic.Clear(); }
    ...
    public Dictionary<int, ServerInfo> GetServerDicInfo() { return serverInfoDic; }
    ...
    public void SetGateServerUin(string uin) { gateServerUin = uin; }
