...
public class BuildAssetBundle {
    ...
    // 打包环境设置
    static BuildAssetBundleOptions options = BuildAssetBundleOptions.CollectDependencies |
    ...
    static Dictionary<int, Dictionary<string, AssetUnit>> allLevelAssets =
        new Dictionary<int, Dictionary<string, AssetUnit>>();
            ...
            foreach (KeyValuePair<string, AssetUnit> pair in levelAssets) {
                ...
                // 场景资源，没有依赖场景的
                    ...
                    string error = BuildPipeline.BuildStreamedSceneAssetBundle(
                        new string[] { pair.Value.mPath }, savePath, buildPlatform);
                    if (error != "")
