...
public class InviteRoomCtrl : Singleton<InviteRoomCtrl> {
    public void Enter() { EventCenter.Broadcast(EGameEvent.eGameEvent_InviteRoomEnter); }

    public void Exit() { EventCenter.Broadcast(EGameEvent.eGameEvent_InviteRoomExit); }
