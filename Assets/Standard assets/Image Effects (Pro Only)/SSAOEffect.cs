...
public class SSAOEffect : MonoBehaviour {
    ...
    void OnDisable() { DestroyMaterial(m_SSAOMaterial); }
    ...
    void OnEnable() { this.GetComponent<Camera>().depthTextureMode |= DepthTextureMode.DepthNormals; }
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination) {
        ...
        m_SSAOMaterial.SetVector("_Params",
                                 new Vector4(m_Radius, m_MinZ, 1.0f / m_OcclusionAttenuation, m_OcclusionIntensity));
