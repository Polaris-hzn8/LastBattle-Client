...
public class MarketRuneInfoWindow : BaseWindow {
    ...
    void ShowWhenRelease(GameObject go) { Show(); }
    // 窗口控件初始化
    ...
    /// 增加界面事件
    /// </summary>
    private void InitWindowEvent() { EventDelegate.Add(mBtnClose.onClick, OnCloseInterface); }
    ...
    public void OnCloseInterface() { MarketRuneInfoCtrl.Instance.Exit(); }
}
}
