...
public class LoginCtrl : Singleton<LoginCtrl> {
    ...
    public void Exit() { EventCenter.Broadcast(EGameEvent.eGameEvent_LoginExit); }
    ...
    public void Login(string account, string pass) {
        ...
        NetworkManager.Instance.Init(JxBlGame.Instance.LoginServerAdress,
                                     JxBlGame.Instance.LoginServerPort,
                                     NetworkManager.ServerType.LoginServer);
        // NetworkManager.Instance.Init("127.0.0.1", 49996, NetworkManager.ServerType.LoginServer);
    }
