...
public class ImportMapData : EditorWindow {
    ...
    private static void GetMapDataHeader(MapObjDataManager manager) {
        ...
        Debug.Log("MapData.Instance.headData.mapWidth  " + SceneMapData.Instance.mapDataStruct.sHeader.mapWidth +
                  " xx " + SceneMapData.Instance.mapDataStruct.sHeader.mapHeight);
    }
...
#region 阻挡数据
    ...
    private static void ReadInfoFromFile() {
        ...
        // MapLength = 20000;
        // GameObject obj_parent = UnityEngine.Object.Instantiate(Resources.Load("Cube/Cubebb"), Vector3.zero,
