...
class LoginState : IGameState {
    ...
    public GameStateType GetStateType() { return GameStateType.GS_Login; }
    ...
    public void Enter() {
        ...
        ResourceUnit sceneRootUnit =
            ResourcesManager.Instance.loadImmediate(GameConstDefine.GameLogin, ResourceType.PREFAB);
        ...
        ResourceUnit audioClipUnit =
            ResourcesManager.Instance.loadImmediate(AudioDefine.PATH_UIBGSOUND, ResourceType.ASSET);
    ...
    public GameStateType Update(float fDeltaTime) { return stateTo; }

    public void OnEvent(CEvent evt) {
        UIPlayMovie.PlayMovie(
            "cg.mp4", Color.black, 2 /* FullScreenMovieControlMode.Hidden*/, 3 /*FullScreenMovieScalingMode.Fill*/);
