...
class RuneEquipModel : Singleton<RuneEquipModel> {
    ...
    public RuneEquipModel() { pagenum = 0; }

    public int getRealPos(int page, int pos) { return page * GameDefine.GameConstDefine.MaxRuneSlot + pos; }
    ...
    public Dictionary<int, uint> GetrunePos2RuneidMap() { return runePgae2SlotInfoMap; }

    public void Clear() { runePgae2SlotInfoMap.Clear(); }
