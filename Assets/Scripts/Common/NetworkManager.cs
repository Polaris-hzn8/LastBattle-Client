...
public class NetworkManager : Singleton<NetworkManager> {
    public enum ServerType { GateServer = 0, BalanceServer, LoginServer }
    ...
    public void UnInit() { canReconnect = false; }
        ...
        if (m_Client != null) {
            ...
            if (mRecvResult != null) {
                ...
                if (mRecvResult.IsCompleted) {
                    ...
                    if (m_Client != null) {
                        try {
                            mRecvResult = m_Client.GetStream().BeginRead(
                                m_RecvBuffer, m_RecvPos, m_RecvBuffer.Length - m_RecvPos, null, null);
                ...
                if (m_Client.Connected) {
                    try {
                        ...
                        m_Client.Client.SetSocketOption(
                            SocketOptionLevel.Socket, SocketOptionName.ReceiveTimeout, 2000);
