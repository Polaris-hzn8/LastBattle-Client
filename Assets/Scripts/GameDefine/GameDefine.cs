...
public class RuneItemInfo {
    public RuneConfigInfo sRuneConfigInfo { get; set; }
...
public enum HeroType { AllHero, AttackHero = 1, AssistHero, SpellHero, DefendHero }
...
public enum LobbyPvpButtom { CUSTOM, NEWBIE_GUIDE_ONE, NEWBIE_GUIDE_TWO, NEWBIE_GUIDE_THREE }
public enum MsgTalk {
    ReadNull,
    UnReadMsg,
    ReadMsg,
...
public enum BattleDataType { HeadIcon, NickName, Level, Kills, Deaths, Assist, LastHit, Goods, Cp }
...
public static class GameConstDefine {
    ...
    public static bool IfHeroBuyCfg(int id) { return id >= HeroBuyCfgIDBegin && id <= HeroBuyCfgIDEnd; }

    public static bool IfRuneBuyCfg(int id) { return id >= RuneBuyCfgIDBegin && id <= RuneBuyCfgIDEnd; }
}
