...
class LoadingState : IGameState {
    ...
    public LoadingState() { mNextState = GameStateType.GS_Continue; }

    public GameStateType GetStateType() { return GameStateType.GS_Loading; }

    public void SetNextState(GameStateType next) { mNextState = next; }
