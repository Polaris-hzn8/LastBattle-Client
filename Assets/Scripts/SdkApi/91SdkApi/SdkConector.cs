...
#region 91SDK - 回调
    ...
    // 初始化成功回调
    void InitSuccessCallBack() { isInitSuccess = true; }
...
#region 91SDK - API
    ...
    public static void ShowToolBar(int point) {
        ...
        jo.Call("ShowToolBar");
#elif UNITY_IPHONE
        // LsNdShowToolBar(point);                 // TODO: API：显示工具条:
    ...
    // public static int NdUniPay(string cooOrderSerial,string productId,string productName,float productPrice,int
    // productCount,string payDescription)
    //{
    ...
    // public static int NdUniPayAsyn(string cooOrderSerial,string productId,string productName,float productPrice,int
    // productCount,string payDescription)
    //{
    ...
    [DllImport("__Internal")]
    private static extern int LSNdUniPay(string cooOrderSerial,string productId,string productName,float
    productPrice,int productCount,string payDescription);

    [DllImport("__Internal")]
    private static extern int LsNdUniPayAsyn(string cooOrderSerial,string productId,string productName,float
    productPrice,int productCount,string payDescription);
