...
public class MessageWindow : BaseWindow {
    ...
    public override void Init() {
        ...
        EventCenter.AddListener<EMessageType, string, Callback<bool>>(EGameEvent.eGameEvent_ShowLogicMessage,
                                                                      ShowMessage);
    }
    ...
    public override void Realse() {
        ...
        EventCenter.RemoveListener<EMessageType, string, Callback<bool>>(EGameEvent.eGameEvent_ShowLogicMessage,
                                                                         ShowMessage);
    }
    ...
    // 隐藏
    public override void OnDisable() { mStatus = EMessageType.EMT_None; }
    ...
    public void BatttleFinished() { mBatttleFinished = true; }
