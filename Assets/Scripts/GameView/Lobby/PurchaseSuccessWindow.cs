...
public class PurchaseSuccessWindow : BaseWindow {
    ...
    private void onClickClose(GameObject go) { Hide(); }
    ...
    protected override void OnAddListener() {
        EventCenter.AddListener<EPurchaseType, string, string, int>(EGameEvent.eGameEvent_PurchaseRuneSuccessWin,
                                                                    UpdatePurchase);
    }

    // 游戏事件注消
    protected override void OnRemoveListener() {
        EventCenter.RemoveListener<EPurchaseType, string, string, int>(EGameEvent.eGameEvent_PurchaseRuneSuccessWin,
                                                                       UpdatePurchase);
    }
