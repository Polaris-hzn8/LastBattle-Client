...
public class IGuideTaskManager {
    ...
    private IGuideTaskManager() { EventCenter.AddListener(EGameEvent.eGameEent_ScenseChange, ChangeScense); }

    ~IGuideTaskManager() { EventCenter.RemoveListener(EGameEvent.eGameEent_ScenseChange, ChangeScense); }
    ...
    public bool IsTriggerTaskFinish() { return triggerTaskFinish; }

    public bool IsLineTaskFinish() { return lineTaskFinish; }
}
}
