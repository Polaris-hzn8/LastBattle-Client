...
public class SkillDescribleWindow : BaseWindow {
    ...
    public override void Init() {
        EventCenter.AddListener<bool, SkillType, Iplayer>(EGameEvent.eGameEvent_SkillDescribleType,
                                                          ShowDescribleByType);
    ...
    public override void Realse() {
        EventCenter.RemoveListener<bool, SkillType, Iplayer>(EGameEvent.eGameEvent_SkillDescribleType,
                                                             ShowDescribleByType);
    ...
    // 显示
    public override void OnEnable() { currentSkill = SkillType.SKILL_NULL; }
    ...
    public SkillType currentSkill { private set; get; }
