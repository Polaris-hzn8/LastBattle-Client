...
public class DebugManager : MonoBehaviour {
    ...
    public static void Log(string str) { errorInfoList.Add(str); }
    ...
    void DebugEffectWindow(int windowID) {
        ...
        foreach (KeyValuePair<Int64, IEffect> pair in effectMap) {
            ...
            string effInfo = "name:" + effName + "  projId:" + projId + "   type:" + effType +
                             "    cehuaTime:" + cehuaTime + "   artTime" + artTime;
    ...
    void DebugErrorWindow(int windowID) {
        errorInfoPos =
            GUILayout.BeginScrollView(errorInfoPos, false, true, GUILayout.Width(800), GUILayout.Height(600));
