...
public class MarketHeroInfoCtrl : Singleton<MarketHeroInfoCtrl> {
    public void Enter() { EventCenter.Broadcast(EGameEvent.eGameEvent_MarketHeroInfoEnter); }

    public void Exit() { EventCenter.Broadcast(EGameEvent.eGameEvent_MarketHeroInfoExit); }
